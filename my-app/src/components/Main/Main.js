...
import closeDark from '../../assets/images/close_dark-mode.png';
            ...
            {selectedSection === 0 && (
                <main>
                    ...
                    <section className="welcome">
                        ...
                        <p className="welcome-text">Un peu plus complet que mon <a href="#">CV classique</a></p>
                    </section>
                </main>
            )}
            {selectedSection !== 0 && (
                <button className="close-section" onClick={() => {sectionToDisplay(0)}}>
                    <img src={darkMode ? closeDark : close} alt="Bouton Fermer" className="close-icon" />
                </button>
            )}
