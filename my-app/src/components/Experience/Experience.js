            ...
            <div className="experience-container">
                        ...
                        <div className="experience-item-description">
                            ...
                            <ul className="content">
                                <li className="content-item">
                                    <h6 className="content-item-title">Développement de mes compétences front-end</h6>
                                    <ul>
                ...
                <section className="experience-item">
                    ...
                    {selectedSection === 2 && (
                        <div className="experience-item-description">
                            <p className="content">
                                Ce CV numérique me sert de carte de visite assez complète tout en me permettant de m'entraîner au responsive, au mode sombre, aux animations et aux affichages et masquages de contenus.</p>
                            <h5 className="experience-description-title">Savoirs acquis</h5>
                            <ul className="content">
